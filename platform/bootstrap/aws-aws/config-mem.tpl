...
{{ source "file:///infrakit/env.ikt" }}
  {
      "ID": "amp-worker-mem-{{ var "/aws/stackname" }}",
      "Properties": {
        "Allocation": {
          "Size": {{ var "/swarm/size/worker/mem" }}
        },
        "Instance": {
          ...
          "Properties": {
            "RunInstancesInput": {
              ...
              "InstanceType": "{{ var "/aws/instancetype/memory" }}",
            ...
            "Tags": {
              "Name": "{{ var "/aws/stackname" }}-worker-mem",
            ...
            "Flavors": [
              {
                ...
                "Properties": {
                  ...
                  "EngineLabels": {{ var "/swarm/labels/worker/mem" | jsonDecode | jsonEncode }}
                }
              }
            ]
          }
