...
import (
	...
	cliflags "github.com/appcelerator/amp/pkg/docker/docker/cli/flags"
...
// SetConfigFile sets the ConfigFile
// This method is specific to AMP. The original code doesn't allow configuration to be updated.
