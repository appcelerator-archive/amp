...
import (
	...
	"github.com/appcelerator/amp/pkg/docker/docker/compose/loader"             //{AMP} make it local
	composetypes "github.com/appcelerator/amp/pkg/docker/docker/compose/types" //{AMP} make it local
