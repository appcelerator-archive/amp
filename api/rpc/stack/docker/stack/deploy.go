...
import (
	...
	"github.com/appcelerator/amp/api/rpc/stack/docker/compose/convert"            //{AMP} make it local
	"github.com/appcelerator/amp/api/rpc/stack/docker/compose/loader"             //{AMP} make it local
	composetypes "github.com/appcelerator/amp/api/rpc/stack/docker/compose/types" //{AMP} make it local
	"github.com/docker/docker/api/types"
	"github.com/docker/docker/api/types/swarm"
	//"github.com/docker/docker/cli" {AMP} remove it
	"github.com/docker/docker/cli/command"
	dockerclient "github.com/docker/docker/client"
	//"github.com/spf13/cobra" {AMP} rmeove it
)
...
func RunDeploy(dockerCli *command.DockerCli, opts deployOptions) error {
	...
	case opts.bundlefile != "":
		//{AMP} no support of Bundle
		return fmt.Errorf("deploy Bundle not supported") //deployBundle(ctx, dockerCli, opts)
	default:
