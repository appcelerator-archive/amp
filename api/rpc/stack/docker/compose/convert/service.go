...
import (
	...
	composetypes "github.com/appcelerator/amp/api/rpc/stack/docker/compose/types"
...
func convertEndpointSpec(source []string) (*swarm.EndpointSpec, error) {
	...
	for port := range ports {
		portConfigs = append(
			portConfigs,
			convertPortToPortConfig(port, portBindings)...)
	}
...
func convertPortToPortConfig(port nat.Port, portBindings map[nat.Port][]nat.PortBinding) []swarm.PortConfig {
