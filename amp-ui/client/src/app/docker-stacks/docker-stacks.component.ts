...
export class DockerStacksComponent implements OnInit {
  ...
  serviceList(stackId : string) {
    ...
    this.menuService.setItemMenu("stacks", "services list", "/amp/stacks/"+stackId)
  }
  ...
  deploy() {
    ...
    this.menuService.setItemMenu("stacks", "services list", "/amp/stacks/deploy")
  }

  update() {
    let stackId = this.dockerStacksService.currentStack.id
    this.menuService.setItemMenu("stacks", "services list", "/amp/stacks/"+stackId+"/deploy")
  }
